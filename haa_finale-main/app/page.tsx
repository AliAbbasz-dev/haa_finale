    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl sm:text-6xl font-bold text-white mb-6 lg:text-6xl">
              ...
              EVERY MILE,
              <br />
              <span className="text-primary">EVERY WARRANTY</span>
            </h1>
            ...
            <div className="flex items-center justify-center space-x-4 mb-8">
              <Link href="/" className="bg-white rounded-full px-6 py-2 hover:bg-gray-100 transition-all duration-200 cursor-pointer shadow-md hover:shadow-lg">
                <span className="text-primary font-semibold">HOME</span>
              </Link>
              <div className="w-2 h-2 bg-white/50 rounded-full" />
              <Link href="/auto" className="bg-primary rounded-full px-6 py-2 hover:bg-primary-600 transition-all duration-200 cursor-pointer shadow-md hover:shadow-lg">
                <span className="text-black font-semibold">AUTO</span>
              </Link>
              <div className="w-2 h-2 bg-white/50 rounded-full" />
              <Link href="/organized" className="bg-white rounded-full px-6 py-2 hover:bg-gray-100 transition-all duration-200 cursor-pointer shadow-md hover:shadow-lg">
                <span className="text-primary font-semibold">ORGANIZED</span>
              </Link>
            </div>
            ...
            <p className="text-primary font-semibold text-lg mb-8 drop-shadow-lg">
      ...
      <section className="py-20 bg-slate-800 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button className="bg-primary hover:bg-primary-600 text-black rounded-full px-8 py-3 font-semibold shadow-md hover:shadow-lg transition-all duration-200">
            Claim Your Listing
          </Button>
        </div>
      </section>
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              <Card className="border-2 border-primary rounded-2xl relative shadow-lg">
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <Badge className="bg-primary text-black px-4 py-1 rounded-full font-medium shadow-md">
                    MOST POPULAR
                  </Badge>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-secondary hover:bg-secondary-800 text-white rounded-full px-8 py-3 font-semibold shadow-md hover:shadow-lg transition-all duration-200">
              Contact Us
            </Button>
            <Button className="bg-primary hover:bg-primary-600 text-black rounded-full px-8 py-3 font-semibold shadow-md hover:shadow-lg transition-all duration-200">
              Get Started Free
